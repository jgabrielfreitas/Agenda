...
public class BaseCalendarEvent implements CalendarEvent {
     ...
     */
    public BaseCalendarEvent(String title, String description, String location, int color, Calendar startTime, Calendar endTime, boolean allDay, boolean rentalBadge) {
        this.mTitle = title;
        this.mDescription = description;
        this.mLocation = location;
        this.mColor = color;
    ...
    public BaseCalendarEvent(BaseCalendarEvent calendarEvent) {
        ...
        this.rentalBadge=calendarEvent.isRentalBadge();
    }
    ...
    public boolean isRentalBadge() {
        return rentalBadge;
    }

    public void setRentalBadge(boolean rentalBadge) {
        this.rentalBadge = rentalBadge;
    }

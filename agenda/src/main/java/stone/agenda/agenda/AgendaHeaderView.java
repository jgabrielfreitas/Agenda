...
import stone.agenda.CalendarManager;
import stone.agenda.R;
import stone.agenda.utils.DateHelper;
...
public class AgendaHeaderView extends LinearLayout {
    ...
    public void setDay(Calendar day, int currentDayTextColor) {
        ...
        SimpleDateFormat dayWeekFormatter = new SimpleDateFormat("EEE", CalendarManager.getInstance().getLocale());

        txtDayOfMonth.setTextColor(ContextCompat.getColor(getContext(), R.color.calendar_text_default));
        txtDayOfWeek.setTextColor(ContextCompat.getColor(getContext(), R.color.calendar_text_default));
